  ...
  Widget build(BuildContext context, WidgetRef ref) => RefreshIndicator(
        ...
        child: Center(
          child: ref.watch(homeProvider).when(
                ...
                data: (data) {
                  final carousels = {
                    context.tr.homeLatestEps:
                        _buildAnimeCards(context, data.newEpisodes, true),
                    context.tr.homeSeasonalAnimes:
                        _buildAnimeCards(context, data.seasonalAnimes),
                    context.tr.homePopularAnimes:
                        _buildAnimeCards(context, data.mostPopularAnimes),
                  };
                  return ListView.separated(
                    ...
                    separatorBuilder: (context, index) =>
                        const SizedBox(height: kPaddingCarousels),
      ...
      [
        ...elements.map(
          (e) => AnimeCard(
            ...
            isEpisode: isEpisode,
            badge: isEpisode ? context.tr.episodeShort(e.episodeNumber) : null,
