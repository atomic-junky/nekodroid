      ...
      body: Center(
        child: ref.watch(animeProvider(animeUrl)).when(
              ...
              data: (anime) {
                ...
                final history =
                    ref.watch(historyProvider).get(anime.url.toString()) ?? {};
                return LazyLoadScrollView(
                  onEndOfPage: () => ref
                      .read(lazyLoadProvider(anime.episodes.length).notifier)
                      .update(
                        (state) => (state +
                      ...
                      children: [
                          ...
                          genres: [
                            for (final genre in anime.genres)
                              GenreChip.click(
                                ...
                                onTap:
                                    () {}, //TODO: open all anime with this genre
                              ),
                          ],
                        ),
                        const SizedBox(height: kPaddingMain),
                        ...
                        Row(
                          ...
                          children: [
                            GenericButton.elevated(
                              onPressed: () => ref
                                  .read(blurThumbsProvider.notifier)
                                  .update((state) => !state),
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final wasWatched =
                                history.containsKey(episode.episodeNumber);
                            return AnimeListTile(
                              ...
                              titleWrap: false,
                              subtitle:
                                  "${episode.duration?.toUnitsString(unitsTranslations: context.tr) ?? context.tr.animeUnknownEpDuration}${wasWatched ? DateTime.fromMillisecondsSinceEpoch(
